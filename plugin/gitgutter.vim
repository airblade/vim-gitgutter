...
call s:set('g:gitgutter_use_scheme_diff_color',       0)
call s:set('g:gitgutter_color_add',                   'guifg=#009900 ctermfg=2')
call s:set('g:gitgutter_color_change',                'guifg=#bbbb00 ctermfg=3')
call s:set('g:gitgutter_color_delete',                'guifg=#ff2222 ctermfg=1')
